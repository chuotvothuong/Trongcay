...
if identifyexecutor then
    local tenExecutor = tostring(identifyexecutor()):lower()
    if tenExecutor:find("solara") or tenExecutor:find("xeno") then
        game:GetService("Players").LocalPlayer:Kick("EXECUTOR KHÔNG ĐƯỢC HỖ TRỢ [ĐỪNG GIẬN, ĐÂY LÀ LỖI CỦA SOLARA/XENO]")
        return
    end
end

local BASE_URL = 'https://raw.githubusercontent.com/joustingmatch/Ouroboros/main/games/'

local danh_sach_game = {
...
local file = danh_sach_game[game.CreatorId]
if file then
